...
const FERRAMENTAS = [
  ...
  { icon: '📈', nome: 'Evolução',     desc: 'Compare o que planejou com o que realmente aconteceu.' },
...
const ROTINA = [
  {
    ...
    passos: [
      ...
      { titulo: 'Acompanhar evolução',  pill: '📈 Evolução' },
        ...
        case 0: return (
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: isMobile ? 16 : 28, flexWrap: 'wrap' }}>
              {[['📊','Controle'],['🎯','Planejamento'],['📈','Evolução'],['🧭','Direção']].map(([ico, lbl]) => (
