 ...
 *
 * A coluna de conciliação só aparece quando alguma linha tem ajuste. Ela é o
 * saldo informado no extrato menos o que a movimentação explicaria — sem ela a
 * linha simplesmente não fecharia, e o usuário ficaria procurando o erro numa
 * conta que está certa.
 */
export default function RadarDetalheContas({ linhas }: { linhas: LinhaMes[] }) {
  ...
  const colunas = `minmax(130px,1.6fr) repeat(${temAjuste ? 5 : 4}, minmax(88px,1fr))`
